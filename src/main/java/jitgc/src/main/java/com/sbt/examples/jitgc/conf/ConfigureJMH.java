//Источник из https://bitbucket.org/ksnovich/java-school/src/master/
//12 лекция СберТех по JIT GC


package jitgc.src.main.java.com.sbt.examples.jitgc.conf;
...
public class ConfigureJMH {

    @Param("default")
    public String mode;

    public static void run_JIT_vs_Interpreter(Class<?> clazz) throws RunnerException {
